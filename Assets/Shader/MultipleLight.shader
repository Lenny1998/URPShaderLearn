        ...
        pass
        {
            ...
            real4 FRAG(v2f i):SV_TARGET
            {
                ...
                for (int i = 0; i < addLightsCount; i++)
                {
                    ...
                    float WS_addLightDir = normalize(addlight.direction);
                    addColor += (dot(WS_Normal, WS_addLightDir) * 0.5 + 0.5) * real4(addlight.color, 1) * tex * addlight.distanceAttenuation *
